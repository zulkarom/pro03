...
class LoaPdf
{
	...
	public function generatePdf(){
		...
		$this->pdf = new LoaTcpdf(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
	...
	$authors = $this->model->articleAuthors;
	$str = '';
		if($authors){
			$i = 1;
			$total = count($authors);
	...
	<table border="0"><tr><td><p style="text-align:justify">Congratulations! We are pleased to inform you that based on peer review process your submission entitled: <strong>'.$this->model->title.'</strong> has been <strong>ACCEPTED</strong> for journal publication volume x issue x 20xx. </p></td></tr></table>
