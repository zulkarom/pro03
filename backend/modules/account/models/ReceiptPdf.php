...
$html = '<table border="0">
<tr><td width="'.$col1.'"><h2>RECEIPT</h2></td>
...
<td width="'.$col2.'" align="right">
<b>RECEIPT NO.</b><br />
RCT'.$this->model->id .'<br />
<b>DATE</b><br />
'. strtoupper(date('d M Y', strtotime($this->model->receipt_date)) ).'<br />
<b>STATUS</b><br />
';
...
$this->pdf->writeHTML($tbl, true, false, false, false, '');
	...
	public function startPage(){
		...
		$this->pdf->SetTitle('RECEIPT '.$this->model->id .' EDUSAGE NETWORK');
