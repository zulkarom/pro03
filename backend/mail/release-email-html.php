...
<div class="password-reset">
    ...
    <p>Sukacita dimaklumkan bahawa permohonan anda (<?=ucwords(strtolower(Html::encode($name))) ?>) telah diluluskan dan surat tawaran boleh dimuat turun melalui sistem e-Fasi di <a href="http://pusatko.umk.edu.my/e-fasi/index.php/user/login">http://pusatko.umk.edu.my/e-fasi</a>.</p>
